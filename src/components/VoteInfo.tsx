...
const VoteData: React.FC<VoteDataProps> = ({ title, totalvotes }) => {
  ...
  return (
    ...
    >
      ...
      <ViewMoreModal toggle={toggleModal} open={open} title={'Yes'} amount={1200} />
      <ViewMoreModal toggle={toggleNoModal} open={openNo} title={'No'} amount={300} />
    </Card>
  )
}
